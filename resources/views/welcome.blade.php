    ...
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                ...
                <img src="https://img.icons8.com/color/64/000000/button--v1.png" alt="controla-logo" height="64px">
                <h1 class="text-gray-600 dark:text-gray-400"> Controla v0.0.1</h1>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><span class="underline text-gray-900 dark:text-white">Login</span></div>
                        </div>
